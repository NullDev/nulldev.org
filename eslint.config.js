...
export default [{                           // NullDev-Style ESLint Config: https://github.com/NullDevCo/JavaScript-Styleguide
    // ...v.configs["flat/recommended"],    // https://eslint.vuejs.org/user-guide/#usage
    ignores: [                              // Ignore dist folders and dependencies
        "dist", "node_modules", "!.vitepress",
    ],
    files: ["**/*.js", "**/*.jsx"],
    plugins: {},                            // Additional ESLint Plugins
    languageOptions: {
        parser: vueParser,                  // npm install @babel/eslint-parser @babel/core eslint --save-dev
